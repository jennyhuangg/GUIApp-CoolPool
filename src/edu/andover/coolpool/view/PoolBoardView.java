...
public class PoolBoardView implements Observer {
	...
	// Brings balls and cuestick in front of all rectangles
	...
	// Sets all handlers for cuestick
	...
	// Unsets handlers for cuestick so that it does not respond to user input
